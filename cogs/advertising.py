...
class AdvertisingCog(commands.Cog):
    ...
    @app_commands.command(name="advertising_on", description="[АДМИН] Включить приём рекламы на этом сервере")
    ...
    @app_commands.command(name="advertising", description="[Скрытая команда]")
